...
export const metadata: Metadata = {
  ...
  description: 'Core App Dashboard is a centralized visual interface that provides an overview of an application\'s key features, data & functionalities.',
  keywords: 'Core App Dashboard, dashboard, application, features, data, functionalities',
...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <html lang="en">
      <head>
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-4JTD40RS70"
